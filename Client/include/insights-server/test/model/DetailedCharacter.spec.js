...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InsightsServer.DetailedCharacter();
  });
  ...
  describe('DetailedCharacter', function() {
    it('should create an instance of DetailedCharacter', function() {
      // uncomment below and update the code to test DetailedCharacter
      //var instane = new InsightsServer.DetailedCharacter();
      //expect(instance).to.be.a(InsightsServer.DetailedCharacter);
    });
