...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InsightsServer.Similarity();
  });
  ...
  describe('Similarity', function() {
    it('should create an instance of Similarity', function() {
      // uncomment below and update the code to test Similarity
      //var instane = new InsightsServer.Similarity();
      //expect(instance).to.be.a(InsightsServer.Similarity);
    });
