...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InsightsServer.SearchInsightDimension();
  });
  ...
  describe('SearchInsightDimension', function() {
    it('should create an instance of SearchInsightDimension', function() {
      // uncomment below and update the code to test SearchInsightDimension
      //var instane = new InsightsServer.SearchInsightDimension();
      //expect(instance).to.be.a(InsightsServer.SearchInsightDimension);
    });
