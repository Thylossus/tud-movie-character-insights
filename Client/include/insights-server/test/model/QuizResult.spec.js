...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InsightsServer.QuizResult();
  });
  ...
  describe('QuizResult', function() {
    it('should create an instance of QuizResult', function() {
      // uncomment below and update the code to test QuizResult
      //var instane = new InsightsServer.QuizResult();
      //expect(instance).to.be.a(InsightsServer.QuizResult);
    });
