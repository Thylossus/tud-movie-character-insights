...
var testData = [{
    normalizedTitle: 'The Lord of the Rings: The Fellowship of the Ring',
    ...
    normalizedTitle: 'Harry Potter and the Sorcerer\'s Stone',
    ...
    normalizedTitle: 'Ich bin ein nicht vorhandener Film - Das Original',
